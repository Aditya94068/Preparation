...
void quickSort(int arr[],int s , int e)
{
    ...
    //partition logc, return pivotIndex
    int p = partition(arr,s,e);
    //recursive calls
    //pivot element ke left main call kar di -> left
    quickSort(arr,s,p-1);
    //pivot element ke right main call kar di -> right
    quickSort(arr,p+1,e);

}
int main()
{
    int arr[] = {8,1,3,4,50,50,50,50,1,1,1,2,2,2,4,4,4,20,50,30};
    int n = 20;
    int s = 0;
    int e = n-1;
    quickSort(arr,s,e);
